...
TEST(guseynov_e_boost_scatter_mpi, test_pipeline_run) {
  ...
  auto testMpiTaskParallel = std::make_shared<guseynov_e_boost_scatter_mpi::TestMPITaskParallel>(taskDataPar);
...
TEST(guseynov_e_boost_scatter_mpi, test_task_run) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_res(1, 0);
  // Create TaskData
