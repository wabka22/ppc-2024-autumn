...
bool sidorina_p_broadcast_m_mpi::Broadcast::validation() {
  internal_order_test();
  if (world.rank() == 0) {
...
bool sidorina_p_broadcast_m_mpi::Broadcast::run() {
  internal_order_test();
...
bool sidorina_p_broadcast_m_mpi::Broadcast::post_processing() {
  internal_order_test();
  if (world.rank() == 0) {
